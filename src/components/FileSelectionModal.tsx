      ...
      {isOpen && (
        ...
        >
          ...
          <div
            ...
            role="dialog"
            aria-modal="true"
            className="bg-bg-primary relative z-10 box-border flex max-w-4xl shrink-0 flex-col overflow-hidden rounded-3xl border border-border-tertiary shadow-2xl min-h-[450px] max-h-[90vh]"
            style={{
